		...
		<div class="col-md-6">
            ...
            <div class="col-md-3">
              <div class="box box-warning">
                ...
                <input type="hidden" class="form-control" id="id" name="id" value="<?php echo (isset($_REQUEST['id']))? $_REQUEST['id'] : '';?>">
								<input type="text" class="form-control" id="code" name="code" value="<?php echo (isset($_REQUEST['code']))? $_REQUEST['code'] : '';?>" placeholder="Subject Code">
								<input type="text" class="form-control" id="class" name="title" value="<?php echo (isset($_REQUEST['title']))? $_REQUEST['title'] : '';?>" placeholder="Subject Title" required>
						  </div><!-- /.form group -->
					</div>
				  </div>	
